    ...
    return (
        <>
            ...
            <Container size="lg" py="lg">
                ...
                <Text>
                    Welcome to <b>Menufic</b> (“Company”, “we”, “our”, “us”)!
                </Text>
                <Text>
                    These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at{" "}
                    <b>https://menufic.com</b> (together or individually “Service”) operated by <b>Menufic</b>.
                </Text>
                <Text>
                ...
                <Text>
                    Menufic has the right but not the obligation to monitor and edit all Content provided by users.
                </Text>
                <Text>
                    In addition, Content found on or through this Service are the property of Menufic or used with
                ...
                <Title order={2}>Prohibited Uses</Title>
                <Text>
                ...
                <List styles={{ item: { color: theme.black } }}>
                    ...
                    <List.Item>Take any action that may damage or falsify Company rating.</List.Item>
                    <List.Item>Otherwise attempt to interfere with the proper working of Service.</List.Item>
                </List>
                <Title order={2}>Analytics</Title>
                <Text>We may use third-party Service Providers to monitor and analyze the use of our Service.</Text>
                <Title order={2}>No Use By Minors</Title>
                <Text>
                ...
                <Text>
                    ...
                    are and will remain the exclusive property of Menufic and its licensors. Service is protected by
                    copyright, trademark, and other laws of and foreign countries. Our trademarks may not be used in
                    connection with any product or service without the prior written consent of Menufic.
                </Text>
                <Title order={2}>Copyright Policy</Title>
                <Text>
                ...
                <Title order={2}>DMCA Notice and Procedure for Copyright Infringement Claims</Title>
                <Text>
                ...
                <List styles={{ item: { color: theme.black } }}>
                    ...
                    <List.Item>your address, telephone number, and email address;</List.Item>
                    <List.Item>
                ...
                <Text>
                    Menufic has no control over, and assumes no responsibility for the content, privacy policies, or
                ...
                <Title order={2}>Disclaimer Of Warranty</Title>
                <Text>
                ...
                <Text>
                    These Terms shall be governed and construed in accordance with the laws of Sri Lanka, which
                ...
                <Title order={2}>Changes To Service</Title>
                <Text>
                ...
                <Title order={2}>Amendments To Terms</Title>
                <Text>
                ...
                <Title order={2}>Waiver And Severability</Title>
                <Text>
