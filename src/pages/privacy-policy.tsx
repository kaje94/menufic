    ...
    return (
        <>
            ...
            <Container py="lg" size="xl">
                ...
                <List styles={{ item: { color: theme.black } }}>
                    ...
                    <List.Item>
                        <Text>
                            ...
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Menufic.
                        </Text>
                    </List.Item>
                    <List.Item>
                        <Text>
                    ...
                    <List.Item>
                        <Text>
                            <strong>Website</strong> refers to Menufic, accessible from{" "}
                ...
                <Title order={4}>Tracking Technologies and Cookies</Title>
                <Text>
                ...
                <List styles={{ item: { color: theme.black } }}>
                    ...
                    <List.Item>Protect and defend the rights or property of the Company</List.Item>
                    <List.Item>Prevent or investigate possible wrongdoing in connection with the Service</List.Item>
                    <List.Item>Protect the personal safety of Users of the Service or the public</List.Item>
